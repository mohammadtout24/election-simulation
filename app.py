...
def api_chat():
    ...
    return jsonify({
        "reply": "<div style='font-size:0.82rem;'>يمكنني مساعدتك بـ:<br><br>"
                 "<b>بدل X مع Y</b> — لتبديل مرشحين<br>"
                 "<b>قارن X مع Y</b> — لمقارنة مرشحين<br>"
                 "<b>حاصل</b> — الحاصل الانتخابي<br>"
                 "<b>من فاز</b> — عرض الفائزين<br>"
                 "<b>أصوات [اسم]</b> — تفاصيل مرشح<br>"
                 "<b>لائحة [اسم]</b> — تفاصيل لائحة<br>"
                 "<b>ملخص</b> — ملخص توزيع المقاعد<br>"
                 "<b>أعلى</b> — أعلى 10 مرشحين</div>",
        "action": "none"
    })
